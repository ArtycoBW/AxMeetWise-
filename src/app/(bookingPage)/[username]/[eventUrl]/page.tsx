...
const BookingPage = async ({ params, searchParams }: IBookingPageProps) => {
          ...
          <CardContent className="p-5 grid md:grid-cols-[1fr,auto,1fr] gap-4">
            <div>
              <Image
                ...
                height={30}
              />
              <p className="text-sm font-medium text-muted-foreground mt-1">{eventType.user.name}</p>
              ...
              <div className="mt-5 grid gap-y-3">
                ...
                <p className="flex items-center">
                  ...
                  <span className="text-sm font-medium text-muted-foreground">{eventType.duration} Mins</span>
                </p>
                <p className="flex items-center">
                  <BookMarked className="size-4 mr-2 text-primary" />
                  <span className="text-sm font-medium text-muted-foreground">{eventType.videoCallSoftware}</span>
                </p>
              </div>
            </div>
          ...
          <CardContent className="p-5 md:grid md:grid-cols-[1fr,auto,1fr,auto,1fr] md:gap-4">
            <div>
              ...
              <div className="mt-5 grid gap-y-3">
                ...
                <p className="flex items-center">
                  <BookMarked className="size-4 mr-2 text-primary" />
                  <span className="text-sm font-medium text-muted-foreground">Google Meet</span>
                </p>
              </div>
            </div>
